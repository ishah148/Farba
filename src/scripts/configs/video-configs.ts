  ...
  promotional: [
    {
      id: 1,
      dataTranslate: 'loft-furniture',
      'caption-header': 'Рекламный видеоролик',
      'caption-subheader': 'Лофт Мебель',
    },
    {
      id: 2,
      dataTranslate: 'shelf-installing',
      'caption-header': 'Видеоролик',
      'caption-subheader': 'Распаковка и установка полки',
    },
    {
      id: 3,
      dataTranslate: 'stroller-review',
      'caption-header': 'Рекламный видеоролик',
      'caption-subheader': 'Обзор детской коляски',
    },
    {
      id: 4,
      dataTranslate: 'dishwasher-review',
      'caption-header': 'Рекламный видеоролик',
      'caption-subheader': 'Обзор посудомоечной машины',
    },
    {
      id: 5,
      dataTranslate: 'hob-review',
      'caption-header': 'Рекламный видеоролик',
      'caption-subheader': 'Обзор варочной панели',
    },
    {
      id: 6,
      dataTranslate: 'oven-review',
      'caption-header': 'Рекламный видеоролик',
      'caption-subheader': 'Обзор духового шкафа',
    },
  ],
